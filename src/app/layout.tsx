...
export const metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicon.png?v=100", type: "image/png" },
      { url: "/assets/polacraft-white-logo-mark.png?v=100", type: "image/png" },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${instrumentSerif.variable} ${bebasNeue.variable} ${syne.variable}`} suppressHydrationWarning>
      <head>
        <link rel="icon" type="image/png" sizes="32x32" href="/favicon.png?v=100" />
        <link rel="icon" type="image/png" sizes="16x16" href="/assets/polacraft-white-logo-mark.png?v=100" />
        <link rel="apple-touch-icon" sizes="180x180" href="/apple-icon.png?v=100" />

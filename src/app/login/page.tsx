...
export default function CustomerLoginPage() {
  ...
  const handleGoogleSignIn = () => {
    ...
    if (!clientId) {
      setErrorMsg("Google OAuth Client ID required. Please add NEXT_PUBLIC_GOOGLE_CLIENT_ID in your Vercel Environment Variables.");
      setIsLoading(false);
      return;
    }
    ...
    // Perform REAL Google OAuth Redirect to accounts.google.com

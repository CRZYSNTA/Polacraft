...
export const PosterRenderer = ({ poster, frame = "unframed", size = "A4" }: any) => {
  ...
  return (
    ...
    >
      {/* 3D Frame Outer Molding & Inner Pass-partout Matboard */}
      <div 
        className={isFramed ? "frame-matboard" : ""}
        style={{
          width: "100%",
          height: "100%",
          position: "relative",
      ...
      >
        ...
        {/* Real Museum Protective Glass Sheen & Reflection Glare */}
        {isFramed && (
          <div 
            style={{
              position: "absolute",
              ...
              height: "100%",
              pointerEvents: "none",
              background: "linear-gradient(135deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0.04) 30%, rgba(255,255,255,0) 60%)",
              zIndex: 3
            }} 
          />
        )}

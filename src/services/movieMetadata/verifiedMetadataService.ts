...
const VERIFIED_CINEMA_DATABASE: Record<string, VerifiedMovieMetadata> = {
  ...
  messi: {
    movie: "Lionel Messi",
    year: 2022,
    director: "Argentina Football Association",
    cast: ["Lionel Messi", "Angel Di Maria", "Emiliano Martinez"],
    genre: "Sports Legend",
    language: "Global Sports",
    tagline: "El Mesías: The Greatest of All Time (GOAT)",
    story: "Celebrating Lionel Messi's historic 2022 FIFA World Cup victory in Qatar and 8 Ballon d'Or legacy. Designed for sports memorabilia collectors and football enthusiasts, this fine art print captures the magical dribbling, vision, and iconic goal celebrations of the Argentine maestro.",
    collectionSuggestions: ["Football Legends", "Sports Icons", "World Cup Champions"],
    tags: ["Messi", "Lionel Messi", "Argentina", "Barcelona", "Inter Miami", "GOAT", "World Cup 2022"],
    verified: true,
  },
  ronaldo: {
    movie: "Cristiano Ronaldo",
    year: 2016,
    director: "Real Madrid & Portugal Legends",
    cast: ["Cristiano Ronaldo", "Luka Modric", "Karim Benzema"],
    genre: "Sports Legend",
    language: "Global Sports",
    tagline: "CR7: The Ultimate Athletic Phenomenon",
    story: "Honoring Cristiano Ronaldo's 5 UEFA Champions League titles, 5 Ballon d'Or awards, and all-time record international goalscoring tally. This archival fine art print celebrates the relentless work ethic, iconic celebration, and athletic dominance of CR7.",
    collectionSuggestions: ["Football Legends", "Sports Icons", "Real Madrid"],
    tags: ["Ronaldo", "Cristiano Ronaldo", "CR7", "Real Madrid", "Manchester United", "Portugal", "Al Nassr"],
    verified: true,
  },
  neymar: {
    movie: "Neymar Jr",
    year: 2015,
    director: "Santos, Barca & Brazil Legends",
    cast: ["Neymar Jr", "Lionel Messi", "Luis Suarez"],
    genre: "Sports Legend",
    language: "Global Sports",
    tagline: "Joga Bonito: Pure Samba Artistry & Dribbling Magic",
    story: "Immortalizing Neymar Jr's electrifying Brazilian flair, UEFA Champions League treble with Barcelona, and joyful Samba football aesthetic. A stunning 300 GSM archival tribute for football lovers.",
    collectionSuggestions: ["Football Legends", "Sports Icons", "Brazil Cinema & Sports"],
    tags: ["Neymar", "Neymar Jr", "Brazil", "Barcelona", "PSG", "Santos", "Joga Bonito"],
    verified: true,
  },
  mbappe: {
    movie: "Kylian Mbappé",
    year: 2018,
    director: "French Football Federation",
    cast: ["Kylian Mbappe", "Antoine Griezmann", "Paul Pogba"],
    genre: "Sports Legend",
    language: "Global Sports",
    tagline: "Speed, Power & World Cup Glory",
    story: "Capturing Kylian Mbappé's explosive World Cup winning campaign in 2018 and historic World Cup Final hat-trick in Qatar. Printed on archival 300 GSM cotton paper for sports art curators.",
    collectionSuggestions: ["Football Legends", "Sports Icons", "Real Madrid"],
    tags: ["Mbappe", "Kylian Mbappe", "France", "PSG", "Real Madrid", "World Cup"],
    verified: true,
  },
  haaland: {
    movie: "Erling Haaland",
    year: 2023,
    director: "Manchester City FC",
    cast: ["Erling Haaland", "Kevin De Bruyne", "Pep Guardiola"],
    genre: "Sports Legend",
    language: "Global Sports",
    tagline: "The Viking Goal Machine: Treble Conqueror",
    story: "Celebrating Erling Haaland's record-breaking 36-goal Premier League debut season and UEFA Champions League Treble victory with Manchester City.",
    collectionSuggestions: ["Football Legends", "Sports Icons"],
    tags: ["Haaland", "Erling Haaland", "Manchester City", "Norway", "Premier League"],
    verified: true,
  },
  maradona: {
    movie: "Diego Maradona",
    year: 1986,
    director: "Napoli & Argentina Legends",
    cast: ["Diego Maradona", "Jorge Valdano", "Burruchaga"],
    genre: "Sports Legend",
    language: "Global Sports",
    tagline: "El Pibe de Oro: The Hand of God & Goal of the Century",
    story: "Immortalizing Diego Armando Maradona's poetic genius during Argentina's 1986 World Cup triumph in Mexico. Capturing the raw emotion, passion, and immortal football heritage.",
    collectionSuggestions: ["Football Legends", "Sports Icons", "Retro Sports Classics"],
    tags: ["Maradona", "Diego Maradona", "Argentina", "Napoli", "1986 World Cup", "Hand of God"],
    verified: true,
  },
  pele: {
    movie: "Pelé",
    year: 1970,
    director: "Santos FC & CBF",
    cast: ["Pelé", "Garrincha", "Jairzinho", "Tostão"],
    genre: "Sports Legend",
    language: "Global Sports",
    tagline: "O Rei: The King of Football",
    story: "Honoring Pelé, the global football ambassador who won 3 FIFA World Cups (1958, 1962, 1970) and scored over 1,000 career goals. The ultimate archival tribute for true football purists.",
    collectionSuggestions: ["Football Legends", "Sports Icons", "Retro Sports Classics"],
    tags: ["Pele", "Pelé", "Brazil", "Santos", "World Cup Legend", "O Rei"],
    verified: true,
  },
  ronaldinho: {
    movie: "Ronaldinho",
    ...
    cast: ["Ronaldinho", "Samuel Eto'o", "Deco"],
    genre: "Sports Legend",
    language: "Global Sports",
    tagline: "The Smiling Magician of Football",
    story: "Celebrating Ronaldinho Gaúcho's Ballon d'Or era at Barcelona, famous Bernabéu standing ovation, and infectious joy that made millions fall in love with the game.",
    collectionSuggestions: ["Football Legends", "Sports Icons", "Barcelona Classics"],
    tags: ["Ronaldinho", "Ronaldinho Gaucho", "Brazil", "Barcelona", "Ballon dOr"],
    verified: true,
  },
};
